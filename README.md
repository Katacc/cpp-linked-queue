...
```
cd existing_repo
git remote add origin https://gitlab.com/Katacc/c-linked-queue.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Katacc/c-linked-queue/-/settings/integrations)
